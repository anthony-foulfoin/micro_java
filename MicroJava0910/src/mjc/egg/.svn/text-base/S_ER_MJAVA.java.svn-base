...
int [] sync= new int[0];
  ...
  private void regle36() throws Exception {
    ...
    //appel
      action_auto_inh_36(x_2, x_3);
    x_2.analyser() ;
    x_3.analyser() ;
      action_type_36(x_2, x_3);
      action_code_36(x_2, x_3);
  }
private void action_code_36(S_ES_MJAVA x_2, S_ERX_MJAVA x_3) throws Exception {
try {
// locales
String loc_valeur;
// instructions
...
private void action_type_36(S_ES_MJAVA x_2, S_ERX_MJAVA x_3) throws Exception {
try {
// locales
String loc_ERXnom;
String loc_ESnom;
// instructions
if (x_3.att_type!=null){
if (!(x_3.att_op.equals("eg"))&&!(x_3.att_op.equals("neg"))){
loc_ERXnom=x_3.att_type.getNom();
loc_ESnom=x_2.att_type.getNom();
if (!(loc_ERXnom.equals("int"))||!(loc_ESnom.equals("int"))){
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IMJAVAMessages.id_MJAVA_exp_rel_invalide, MJAVAMessages.MJAVA_exp_rel_invalide,new Object[]{});

}

}
else {
if (!(x_3.att_type.isCompatible(x_2.att_type))){
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IMJAVAMessages.id_MJAVA_exp_rel_invalide, MJAVAMessages.MJAVA_exp_rel_invalide,new Object[]{});
...
private void action_auto_inh_36(S_ES_MJAVA x_2, S_ERX_MJAVA x_3) throws Exception {
try {
// instructions
